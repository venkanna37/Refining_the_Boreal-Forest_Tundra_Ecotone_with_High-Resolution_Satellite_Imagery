...
class TinyUNet(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, size='small'):
        ...
        self.act4 = nn.ELU(inplace=True)

        self.conv5 = nn.Conv2d(ch[3], ch[4], kernel_size=3, padding=0)
        self.act5 = nn.ELU(inplace=True)
